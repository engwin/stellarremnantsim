...
class Window(QMainWindow):
    ...
    def yesclick(self):
        ...
        self.label.setFixedHeight(600)
        self.label.setFixedWidth(600)
        self.text.setText("Your star is in a white dwarf binary system!")
        self.text.adjustSize() 
        self.text.show()
    ...
    def bonusround(self):
        self.text.setText("Press the button below to accrete as much mass as you can in 20 seconds!")
        ...
        self.accrete.show()
        self.accrete.raise_()
        QTimer.singleShot(20000, self.endscreen)
    ...
    def endscreen(self):
        ...
        if self.counter_value <= 80:
            ...
            self.text2.adjustSize() 
        if self.counter_value in range (81, 130):
...
# Image references
# M16 https://webbtelescope.org/contents/media/images/2022/052/01GFNKCR90HRDPMRT4E311C689?Tag=Nebulas
